...
namespace com::github::coderodde::pathfinders::api {
	...
	public:
		TargetNodeSelector(
			DirectedGraph<Node>& directed_graph,
			DirectedGraphWeightFunction<Node, Weight>& directed_graph_weight_function,
			Node& source_node)
			:
			directed_graph_{ directed_graph },
			directed_graph_weight_function_{ directed_graph_weight_function },
	...
	public:
		...
		SourceNodeSelector<Node, Weight> withWeights(
			DirectedGraphWeightFunction<Node, Weight>&
			directed_graph_weight_function) {
			return SourceNodeSelector(directed_graph_, directed_graph_weight_function);
		}
	};
	...
	class GraphSelector {
	public:
		WeightFunctionSelector<Node, Weight> in(DirectedGraph<Node>& directed_graph) {
